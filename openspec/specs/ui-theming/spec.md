...
TBD — defines the application's Material UI theming and styling approach: a single shared theme applied across all routes, server-side rendered styles, and use of MUI components in place of raw HTML elements on existing pages.
